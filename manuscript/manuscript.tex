...
HMMs require the dynamics in some hidden (i.e., unobserved) state space to be Markovian.
...
An HMM estimation usually yields a model with a small number of (hidden) states
