...
In order to interpret the slowest relaxation timescales, we refer to the (right) eigenvectors of the MSM, as they are independent of the stationary distribution of the MSM.
