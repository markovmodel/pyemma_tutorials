...
\noindent{}where the left-hand side of the equation corresponds to an MSM estimated at lag time $k\tau$, where $k$ is an integer larger than 1, whereas the right-hand side of the equation is our estimated MSM to the $k^\textrm{th}$ power.
...
\begin{itemize}
	...
	The features or TICs are grouped using a clustering algorithm such as $k$-means into a set of states.
